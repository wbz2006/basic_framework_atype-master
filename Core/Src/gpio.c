...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, MAG_RST_Pin|GPIO_PIN_5|GPIO_PIN_6|LED_R_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, Laser_Pin|D8_Pin|D7_Pin|D6_Pin
                          |D5_Pin|D4_Pin|D3_Pin|D2_Pin
  ...
  GPIO_InitStruct.Pin = MAG_RST_Pin|LED_R_Pin;
  ...
  GPIO_InitStruct.Pin = HJ_L1_Pin|HJ_L2_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = HJ_M_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(HJ_M_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PBPin PBPin */
  GPIO_InitStruct.Pin = HJ_R1_Pin|HJ_R2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
